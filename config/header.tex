...
\renewcommand{\section}[1]{\insectiontrue\oldsection{#1}\insectionfalse}
\let\oldsubsection\subsection
\renewcommand{\subsection}[1]{\insectiontrue\oldsubsection{#1}\insectionfalse}
\let\oldsubsubsection\subsubsection
\renewcommand{\subsubsection}[1]{\insectiontrue\oldsubsubsection{#1}\insectionfalse}
  ...
  \oldep{\the\everypar%
    ...
    \else
      ...
      \else
        ...
        \tabto*{\TabMargPos}\makebox[0pt]{\tiny \theparcount \normalsize}%
      \fi
    \fi
    \tabto*{\TabPrevPos}}%
