% Font settings
\usepackage{fontspec}
\setmainfont{Times New Roman} % Use a traditional serif font like Times New Roman for a legal look
\setsansfont{Arial} % For any sans-serif text
\setmonofont{Courier New} % For any monospaced text, if needed
...
% Header for first page with document title
\usepackage{titling}
